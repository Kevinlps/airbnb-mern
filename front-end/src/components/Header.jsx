...
const Header = () => {
  return (
    ...
    <div className='flex items-center justify-between px-8 py-4 max-w-7xl mx-auto'>
        ...
        <div className='flex items-center border border-gray-300 px-4 py-2 pl-6 rounded-full shadow-md'>
      ...
      <div className='flex items-center border border-gray-300 px-4 py-2 pl-6 rounded-full shadow-md gap-2'>
